...
public class GerenciaClientes implements Runnable{
    ...
    private void solicitarJogada() {
        ...
        if (msgplayer1 != null) {
            msgplayer1.println(Mensagens.RODADA + rodadaAtual + Mensagens.FORMAT);
            msgplayer1.println(Mensagens.PLACAR + placarPlayer1 + " x " + placarPlayer2 + Mensagens.OPONENTE);
            msgplayer1.println(Mensagens.JOGADA);
        }
        if (msgplayer2 != null) {
            msgplayer2.println(Mensagens.RODADA + rodadaAtual + Mensagens.FORMAT);
            msgplayer2.println(Mensagens.PLACAR + placarPlayer2 + " x " + placarPlayer1 + Mensagens.OPONENTE);
            msgplayer2.println(Mensagens.JOGADA);
        }
    }
    ...
    private void encerrarJogo() {
        ...
        if (placarPlayer1 >= 3) {
            msgplayer1.println(Mensagens.VCVENCEU);
            msgplayer1.println(Mensagens.PLACARFINAL + placarPlayer1 + " x " + placarPlayer2 + Mensagens.OPONENTE);
            msgplayer2.println(Mensagens.VCPERDEU);
            msgplayer2.println(Mensagens.PLACARFINAL + placarPlayer2 + " x " + placarPlayer1 + Mensagens.OPONENTE);
        } else if (placarPlayer2 >= 3) {
            msgplayer2.println(Mensagens.VCVENCEU);
            msgplayer2.println(Mensagens.PLACARFINAL + placarPlayer2 + " x " + placarPlayer1 + Mensagens.OPONENTE);
            msgplayer1.println(Mensagens.VCPERDEU);
            msgplayer1.println(Mensagens.PLACARFINAL + placarPlayer1 + " x " + placarPlayer2 + Mensagens.OPONENTE);
        }
